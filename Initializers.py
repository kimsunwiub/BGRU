...
def my_xavier_initializer(uniform=True, seed=None, dtype=dtypes.float32, gain=1.0):
  ...
  return variance_scaling_initializer(factor=1.0, mode='FAN_AVG',
                                      uniform=uniform, seed=seed, dtype=dtype, gain=gain)


def variance_scaling_initializer(factor=2.0, mode='FAN_IN', uniform=False,
                                 seed=None, dtype=dtypes.float32, gain=1.0):
  ...
  * To get `xavier_initializer` use either:<br/>
  ...
  def _initializer(shape, dtype=dtype, partition_info=None):
    ...
    if uniform:
      ...
      trunc_stddev = math.sqrt(1.3 * factor / n) * gain
