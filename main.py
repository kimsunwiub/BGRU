...
def main():
    ...
    plot_name = 'Saved_Results/lr{}_s,t_{},{}_betas{},{}_clip{}_SNR{:.4f}'.format(args.learning_rate, args.sparsity_gru, args.sparsity_out, args.beta1, args.beta2, args.clip_val, model.va_snrs.max())
